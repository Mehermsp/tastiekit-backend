...
async function migrate() {
    ...
    `);
      ...
      `);
        ...
        ('Spice Haven', 'Authentic Indian cuisine with rich flavors and traditional recipes from across India.', 'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=400', 'Indian', 4.6, 35),
        ('Pizza Palace', 'Fresh wood-fired pizzas, pastas and classic Italian favorites made with love.', 'https://images.unsplash.com/photo-1513104890138-7c749659a591?w=400', 'Italian', 4.7, 40),
        ('Green Bowl', 'Healthy salads, fresh juices, smoothies and nutritious bowls for wellness.', 'https://images.unsplash.com/photo-1546793665-c74683f339c1?w=400', 'Healthy', 4.4, 25),
        ('Fusion Street', 'Street food fusion with Indo-Chinese, Continental and global street eats.', 'https://images.unsplash.com/photo-1552611052-33e04de081de?w=400', 'Fusion', 4.5, 30)
      `);
